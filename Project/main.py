...
"""
graph = nx.read_gml("adjnoun.gml")
nx.draw(graph, with_labels=1)
"""

# Ler Italian Gangs Network
"""
graph_data = genfromtxt('ITALIAN_GANGS.csv', delimiter=',')
...
countries_data = genfromtxt('ITALIAN_GANGS_ATTR.csv', delimiter=',')
...
"""
graph = nx.read_edgelist('junit.txt', comments='#')
nx.draw(graph, with_labels=1)
"""
